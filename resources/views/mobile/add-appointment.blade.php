    ...
    <div class=" m-appoint-add col-md-4 col-md-offset-4">
        ...
        <div class="main-group row form-group {{ $errors->has('end_time') ? 'has-error' :'' }}">
            ...
            <div class="col-xs-8">
                ...
                <input id="endtime" class="form-control" type="text" name="end_time">
                <span class="help-block">
        ...
        <div class="main-group row form-group {{ $errors->has('organisation_id') ? 'has-error' :'' }}">
            ...
            <div class="col-xs-8">
                ...
                <select class="select2 form-control" name="organisation_id" >
        ...
        <div class="row tasks">
          <div class="col-md-12">
            @include('partials.mobile-get-ready')
            @include('partials.mobile-getting-there')
            @include('partials.mobile-after-appointment')
          </div>
        </div>
