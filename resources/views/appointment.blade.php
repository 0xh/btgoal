...
<div class="flash-message">
  ...
  <form role="form" enctype="multipart/form-data" method="post" action="/appointment/create">
     @include('partials.appoint')
    {{ csrf_field() }}
    <div class="row">
        @include('partials.get-ready')
        @include('partials.getting-there')
        @include('partials.after-appointment')
    </div>
  ...
  var basicExampleEl3 = document.getElementById('date-time-ready');
  var datepair3 = new Datepair(basicExampleEl3);
  var basicExampleEl4 = document.getElementById('date-time-there');
  var datepair4 = new Datepair(basicExampleEl4);
  var basicExampleEl5 = document.getElementById('date-time-after');
  var datepair5 = new Datepair(basicExampleEl5);
  $('#date-time input').on('change',function(){
    // place this within dom ready function
    function copydate() {     
      endtime = $('#end_time').val();
      //$("#after_appointment_start_time").val(endtime);
      $('#date-time-after .time').timepicker({
        'showDuration': true,
        'minTime': endtime,
        'scrollDefault': endtime,
        'timeFormat': 'g:ia'
      });
    }
    // use setTimeout() to execute
    setTimeout(copydate, 1000)
