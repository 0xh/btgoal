    ...
    <input type="hidden" name="getting_there_id" value="{{ old('getting_there_id', $getting_task->id) }}">
      ...
      <div id="date-time-there">
        <div id="date-time" class="form-group {{ $errors->has('getting_there_start_time') ? 'has-error' :'' }}" >
          ...
          <input id="getting_there_start_time" type="text" class="time start form-control" name="getting_there_start_time" 
          @if ($getting_task->start_date)
        ...
        <div id="date-time" class="form-group {{ $errors->has('getting_there_end_time') ? 'has-error' :'' }}" >
          ...
          <input id="getting_there_end_time" type="text" class="time end form-control" name="getting_there_end_time" 
          @if ($getting_task->end_date)
      ...
      <div class="form-group {{ $errors->has('getting_there_detail') ? 'has-error' :'' }}" >
          ...
          <textarea id="getting_there_detail" class="form-control" rows="5" name="getting_there_detail" >{{ old('getting_there_detail', $getting_task->detail) }}</textarea>
          <span class="help-block">
      ...
      <div class="form-group {{ $errors->has('getting_there_address') ? 'has-error' :'' }}" >
        ...
        <input id="getting_there_address" type="text" class="form-control form-address-input" name="getting_there_address" value="{{ old('getting_there_address', $getting_task->address) }}">
        <span class="help-block">
