  ...
  <div class="panel panel-content panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group {{ $errors->has('get_ready_detail') ? 'has-error' :'' }}" >
          ...
          <textarea id="get_ready_detail" class="form-control" rows="5" name="get_ready_detail">{{ old('get_ready_detail') }}</textarea>
          <span class="help-block">
        ...
        <div class="form-group {{ $errors->has('get_ready_address') ? 'has-error' :'' }}" >
              ...
              <input id="get_ready_address" type="text" class="form-control form-address-input" name="get_ready_address" value="{{ old('get_ready_address') }}">
              <span class="help-block">
